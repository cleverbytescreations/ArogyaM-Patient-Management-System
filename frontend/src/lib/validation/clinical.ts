...
export const dischargeSummarySchema = z
  .object({
    ...
    investigations_admission: z.string().max(2000, "Too long").optional(),
    treatments: z.string().max(2000, "Too long").optional(),
    condition_at_discharge: z.string().max(120, "Too long").optional(),
    follow_up_period: z.string().max(120, "Too long").optional(),
